...
| 文件 | 行数（约） | 角色 |
|---|---|---|
| [`v4l2stateless.c`](front.md) | 2200 | VA 前端、vtable、对象生命周期、EndPicture 分派 |
| [`v4l2stateless.h`](front.md) | 520 | 全部公开结构与原型 |
| [`v4l2stateless_device.c`](device.md) | 1300 | Request API 引擎、池、pull_capture、reset |
...
| [`v4l2stateless_gbm.c`](gbm.md) | 230 | 显示用 R8 bo、PRIME 描述符 |
...
| [`v4l2stateless_vpp.c`](vpp.md) | 430 | RGA scale/CSC/rotate |
